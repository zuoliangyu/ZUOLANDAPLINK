...
### 修复
- 🐛 **修复构建配置** - 移除不支持的 NSIS portable 配置，恢复正常构建

### 改进
- 🎨 **发布说明优化** - 更新 GitHub Actions 发布说明

### 技术细节
- Tauri 2.0 的 NSIS 配置不支持 `portable` 字段
- NSIS 安装程序已经足够轻量，支持自定义安装位置
